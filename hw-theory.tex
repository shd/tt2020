...
\begin{enumerate}
\item Равенство. Прочтите описание равенства в языке Аренд 
\url{https://arend-lang.github.io/documentation/tutorial/PartI/idtype}
(и при необходимости другие части описания языка)
...
\begin{enumerate}
\item $a < a + b$; то есть, определите функцию\\\verb!\func n_less_sum (a b : Nat) : NatLess a (a Nat.+ b)!
